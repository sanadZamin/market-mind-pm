        ...
        >
          ...
          <div className="glass-panel p-8 rounded-3xl">
            <div className="mb-8 text-center">
              <h1 className="text-2xl font-bold text-white mb-2 font-display">Create an account</h1>
              <p className="text-white/55 text-sm">Join your team and start managing projects</p>
            </div>
